...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/betosshvip/crashvarm/main/lib/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/betosshvip/crashvarm/main/Modulos/antCrashARM.sh -o /dev/null
